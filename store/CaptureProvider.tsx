...
import React, { ComponentProps, createContext, PropsWithChildren, useContext, useRef, useState } from 'react';
...
export const CaptureProvider: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return <CaptureContext.Provider value={{ capture, setImageRef }}>{children}</CaptureContext.Provider>;
};
